...
def signal(mode,rs,i):
 ...
 if mode in ('vol_cont','vol_cont_break','vol_cont_break_body'):
  ...
  if c>o and c>s50 and (mode=='vol_cont' or c>ph): return 'long'
  if c<o and c<s50 and (mode=='vol_cont' or c<pl): return 'short'
  return None
