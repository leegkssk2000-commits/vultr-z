...
def _history_readiness()->dict[str,Any]:
    # Economic replay readiness, not mere native-source ownership.
    out:dict[str,Any]={
...
def main()->int:
    ...
    r=run(a.output); print(canonical({"done":r["ledger_done_count"],"terminal":r["terminal_count"],"ready_sources":r["replay_ready_sources"],"machine":r["machine_replayable_count"],"dev_pass":r["development_economic_pass_count"],"gemini_batch":r["gemini_batch"],"evidence":r["evidence_summary"]})); return 0
