...
def main() -> int:
    ...
    for k in ("same_parent_child_boundary_required","same_execution_snapshot_required","same_cost_authority_required","terminal_same_axis_retest_forbidden","a1_a2_a3_gate_order_preserved"):
    ...
    r = {
        "state": "PASS_ORIGINAL_FRESH_DIRECT_AB_GUARD" if not defects else "HOLD_ORIGINAL_FRESH_DIRECT_AB_GUARD",
        "defects": defects,
        "action": "hold",
