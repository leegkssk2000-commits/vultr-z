...
v1.SCHEMA = "zel.a1.loss_streak_repair_regression.v5"
v1.CASES = {
    "trend_rider": {
        "trigger_run_id": 32623644328,
        "parent_policy": "backend/research/rebuild/trend_rider_transition_freshness_child_policy_v1.py",
        "child_policy": "backend/research/rebuild/trend_rider_transition_freshness_chase_cooling_child_policy_v1.py",
        ...
        "changed_axis": "CHASE_ATR_NOT_EXPANDING_VS_PRIOR_CLOSED_BAR_ON_TRANSITION_FRESHNESS_INCUMBENT",
    },
    "keltner_trend": {
        "trigger_run_id": 32624307572,
        "parent_policy": "backend/research/rebuild/breakout_policy_batch_v1.py",
        "child_policy": "backend/research/rebuild/keltner_trend_chase_strengthening_child_policy_v1.py",
        "expected_context_trade_count": 24,
        ...
        "changed_axis": "CHASE_ATR_STRENGTHENING_VS_PRIOR_CLOSED_BAR",
    },
}
