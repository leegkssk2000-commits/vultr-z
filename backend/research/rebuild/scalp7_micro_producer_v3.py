...
from backend.research.rebuild.scalp7_micro_decision_v2 import IDENTITY, MicroSourceError
from backend.research.rebuild.scalp7_micro_decision_v3 import (
    ClockMicroDecision as MicroDecision,
)
...
def _code_hashes() -> dict[str, str]:
    ...
    return {
        ...
        for name in (
            ...
            "scalp7_micro_decision_v3.py",
            "scalp7_micro_producer_v3.py",
            "scalp7_trade_raw_source_v3.py",
            "scalp7_source_clock_v3.py",
...
def initialize(out: Path, source: Path) -> dict[str, Any]:
    ...
    if (
        source_identity.get("clock_profile")
        != "PRESERVED_TIMESTAMPS_ACTUAL_CLOCK_BARRIER_V3"
    ):
        raise MicroSourceError("ACTUAL_CLOCK_SOURCE_PROFILE_REQUIRED")
    ...
    freeze = {
        ...
        "decision_tf_min": 15,
        "technical_source_revision": "V3_ACTUAL_CLOCK_BARRIER_ORIGINAL_V2_ECONOMIC_GRAMMAR",
