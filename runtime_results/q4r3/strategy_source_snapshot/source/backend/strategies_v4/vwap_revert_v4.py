...
# Strategy: vwap_revert|enter_long
# Role: main
# Source: /home/z/z/backend/strategies/vwap_revert.py
# Original strategy is not modified.

from h85v_common import evaluate_candidate

STRATEGY_KEY = "vwap_revert|enter_long"
ROLE = "main"
SOURCE_STRATEGY_FILE = '/home/z/z/backend/strategies/vwap_revert.py'
