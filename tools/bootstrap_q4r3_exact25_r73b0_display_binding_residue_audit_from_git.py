...
def main() -> int:
    ...
    try:
        ...
        print(f"SUPPRESSED_NONCRITICAL_RECORD_COUNT={payload.get('suppressed_noncritical_record_count', 0)}")
        ...
        print(f"WARNING_COUNT={payload.get('warning_count', 0)}")
        print(f"OPTIONAL_SCAN_ROOT_MISSING_COUNT={payload.get('optional_scan_root_missing_count', 0)}")
