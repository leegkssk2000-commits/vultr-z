...
def main() -> int:
    ...
    validator = wt / "tools/q4r3_team_advisor_r22_validate_sbot_sgrade.py"
    ...
    contract = wt / "config/q4r3_sbot_sgrade_contract_v1.json"
    output = root / "runtime/exact25_edge_v1/team_advisor_r22_sbot_sgrade/status_latest.json"
    required = [
        *tests, validator, r21, r12, contract,
    ...
    print("Q4R3_TEAM_ADVISOR_R22_SBOT_SGRADE_COMPLETE")
