...
def main() -> int:
    ...
    validator = wt / "tools/q4r3_team_advisor_r24_validate_mbot_sgrade.py"
    r23 = root / "runtime/exact25_edge_v1/team_advisor_r23_lbot_sgrade/status_latest.json"
    contract = wt / "config/q4r3_mbot_sgrade_contract_v1.json"
    output = root / "runtime/exact25_edge_v1/team_advisor_r24_mbot_sgrade/status_latest.json"
    required = [
        *tests, validator, r23, contract,
    ...
    print("Q4R3_TEAM_ADVISOR_R24_MBOT_SGRADE_COMPLETE")
