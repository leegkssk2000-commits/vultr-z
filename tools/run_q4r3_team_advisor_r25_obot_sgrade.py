...
def main() -> int:
    ...
    validator = wt / "tools/q4r3_team_advisor_r25_validate_obot_sgrade.py"
    r24 = root / "runtime/exact25_edge_v1/team_advisor_r24_mbot_sgrade/status_latest.json"
    contract = wt / "config/q4r3_obot_sgrade_contract_v1.json"
    output = root / "runtime/exact25_edge_v1/team_advisor_r25_obot_sgrade/status_latest.json"
    required = [
        *tests, validator, r24, contract,
    ...
    print("Q4R3_TEAM_ADVISOR_R25_OBOT_SGRADE_COMPLETE")
